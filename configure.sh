...
select DESKTOP in none openbox lxde xfce mate lxqt kde gnome hyprland; do
    case "$DESKTOP" in
        none|openbox|lxde|xfce|mate|lxqt|kde|gnome|hyprland) break ;;
        *) echo "Invalid choice, pick 1-9." ;;
    esac
done
